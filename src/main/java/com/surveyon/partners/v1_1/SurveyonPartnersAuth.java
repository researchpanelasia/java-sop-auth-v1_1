...
public class SurveyonPartnersAuth {
	...
	public SurveyonPartnersAuth(Map params, String secret) throws Exception {		
		this.generateSignature(params, secret);
	}
	
	public static boolean verifySignature(Map params, String secret) throws Exception{
	...
	private String generateSignature(Map params, String secret) throws Exception {
		//create HTTP parameter string
		String combined = SurveyonPartnersAuth.createCombinedParameter(params);
	...
	private static String createCombinedParameter(Map params) throws Exception {
